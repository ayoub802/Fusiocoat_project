...
function Contact() {
  return (
    ...
    <div className='mt-[88px] lg:mt-[98px]'>
        <Banner image={BannerImage} chemin="Acceuil" title="Contact"/>
        <section className='bg-white'>
                <div className="container">

                  <div className='row mt-5 items-start'>
                      <div className="col-md-3">
                            <h3 className="font-bold text-[20px] mb-2 text-black">FusioCoat</h3>

                            <div className="my-4">
                                <h3 className='font-medium leading-6'>
                                <span className='font-bold text-black'>PADRESSE POSTALE ADMINISTRATIVE :</span> 
                                 FUSIOCOAT® : 442 Rue Georges Besse, 30000 Nîmes, France
                                </h3>
                            </div>
                            <div className="my-4">
                                <h3 className='font-medium leading-6'>
                                <span className='font-bold text-black'>ÉCRIVEZ-NOUS :</span> 
                                Service Technique: technical@fusiocoat.com
                                </h3>
                            </div>
                            <div className="my-4">
                                <h3 className='font-medium leading-6'>
                                <span className='font-bold text-black'>ÉCRIVEZ-NOUS :</span> 
                                Service Commercial: sales@fusiocoat.com
                                </h3>
                            </div>
                      ...
                      <div className="col-md-6">
                         ...
                         <h3 className='font-medium leading-6 text-center'>
                           Veuillez renseigner les informations demandées. Tous les champs (*) sont obligatoires.
                         </h3>
